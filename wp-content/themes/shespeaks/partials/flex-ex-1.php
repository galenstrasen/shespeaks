<header class="main-header">
  ...
  <div class="banner">
    <img class="logo" src="/wp-content/themes/shespeaks/partials/img/city-logo.svg" alt="City">
  ...
  <div class="row">
    <div class="primary col">
      <h2>Great food</h2>
      <img class="feat-img" src="/wp-content/themes/shespeaks/partials/img/treats.svg" alt="Drinks and eats">
